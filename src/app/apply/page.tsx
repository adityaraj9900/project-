...
export default function ApplyPage() {
  return (
    <main className="bg-[#080808] pt-32 pb-24">
      ...
      <Section>
        <Reveal><SectionHeader center eyebrow="Apply" title="Start your internship." subtitle="Choose a program below and submit your application. It's completely free." /></Reveal>
        <Reveal delay={0.1}><div className="flex justify-center"><Link href="/programs"><Button variant="gold" size="lg">Browse programs <ArrowRight size={15} /></Button></Link></div></Reveal>
      </Section>
    </main>
  );
}
